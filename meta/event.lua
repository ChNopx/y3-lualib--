...
event.ET_TRIGGER_UI_SLIDER_CHANGE_EVENT = {
    ...
    [5] = {
        ...
        lua_desc = "ui",
        lua_code = function (data)
            local ui = y3.控件.获取于HD(data.player, data.comp_name)
            return ui
        end,
    },
}
...
---@field 触发单位 Unit # 获得该物品的单位
---@field 触发物品 Item # 物品
---@field 物品编号 py.ItemKey # 物品编号
